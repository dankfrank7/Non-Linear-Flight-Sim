...
function [ FlightData ] = aero3560_LoadFlightDataPC9_nominalCG1()
    ...
    FlightData.Aero.Cma  = -0.802;% This is different
    FlightData.Aero.Cmq  = -17.72;% This is different
    FlightData.Aero.Cmad = -2.210;
    FlightData.Aero.Cmde = -1.822;
    % N Moment Coefficients
    FlightData.Aero.Cnb  =  0.107;% This is different
    FlightData.Aero.Cnbd =  0.0015;
    FlightData.Aero.Cnp  = -0.0226;
    FlightData.Aero.Cnr  = -0.160;% This is different
